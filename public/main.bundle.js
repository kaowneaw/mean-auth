...
var appRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_13__components_home_home_component__["a" /* HomeComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_8__guards_auth_guard__["a" /* AuthGuard */]] },
...
var LoginComponent = (function () {
    function LoginComponent(authService, flashMessages, router, validateService) {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenUser(user).subscribe(function (data) {
            console.log(data);
            if (data.success) {
                _this.authService.storeUserData(data.token, data.user);
                _this.flashMessages.show('Login Success', { cssClass: 'alert-success', timeout: 3000 });
...
var ProfileComponent = (function () {
    function ProfileComponent(flashMessages, authService, router) {
        this.flashMessages = flashMessages;
        this.authService = authService;
        this.router = router;
    }
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessages.show('Register Success', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessages.show('Register Fail', { cssClass: 'alert-danger', timeout: 3000 });
            }
        });
    };
...
var AuthService = (function () {
    ...
    AuthService.prototype.authenUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Conent-Type', 'application/json');
...
var ValidateService = (function () {
    ...
    ValidateService.prototype.validateAuthen = function (user) {
